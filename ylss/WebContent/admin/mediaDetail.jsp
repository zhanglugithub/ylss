			...
			<div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form:form commandName="doctor" role="form" method="post" class="validate" action="updateMedia.do?review=false&id=${media.id}">
						标题：<br>
							<input type="text" name="title" value="${media.title}" class="form-control"><br>
						缩略图地址：
							<input type="text" name="image" value="${media.image}" class="form-control"><br>
						资讯链接：
							<input type="text" name="link" value="${media.link}" class="form-control"><br>
							<div class="form-group">
								<c:if test="${media.id==null}">
