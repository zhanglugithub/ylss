	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">查看应聘</h1>
					<p class="description">查看医生的应聘情况</p>
				</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel panel-default">
						...
						<table class="table table-model-2 table-hover">
							...
							<tbody>
								<c:forEach var="applyOffer" items="${applyOfferList}">
									<tr>

										<td>${applyOffer.offerId}</td>
										<td>${applyOffer.name}</td>
										<td>${applyOffer.phoneNo}</td>
										<td>${applyOffer.hospital}</td>
										<td>${applyOffer.requirement}</td>
					...
					<div class="title-env">
						...
						<c:forEach var="pageNo" begin="1" end="${totalNo/10+1}">
							<a href="listApplyOffer.do?pageSize=10&pageNo=${pageNo}">
								${pageNo} </a>
