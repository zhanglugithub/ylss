	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">科室</h1>
					<p class="description">所有科室</p>
				</div>
			...
			<div>
				...
				<c:if test="${keShi.code==1}">
					<div class="panel panel-default">
						<!-- start content -->
						<div align="right">
							<a href="search/keShiInfo.jsp" class="btn btn-success"
								style="font-size: 20px;">添加科室</a>
						</div>
						<table class="table table-model-2 table-hover">
							...
							<tbody>
								<c:forEach var="keShi" items="${keShi.keShiList}">
									<tr>
										<td>${keShi.getKeShiId()}</td>
										<td>${keShi.getKeShi()}</td>
										<td><a
											href="detailKeShi.do?keShiId=${keShi.getKeShiId()}"
						...
						<div class="title-env">
							<c:forEach var="pageNo" begin="1" end="${keShi.pageCount}">
