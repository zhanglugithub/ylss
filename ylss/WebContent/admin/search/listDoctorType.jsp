	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div>
				...
				<c:if test="${doctorType.code==1}">
					<div class="panel panel-default">
						<!-- start content -->
						<div align="right">
							<a href="search/doctorTypeInfo.jsp" class="btn btn-success"
								style="font-size: 20px;">添加类别</a>
						</div>
						<table class="table table-model-2 table-hover">
							...
							<tbody>
								<c:forEach var="doctor" items="${doctorType.doctorList}">
									<tr>
										<td>${doctor.getDtId()}</td>
										<td>${doctor.getDoctorType()}</td>
										<td><a
											href="detailDoctorType.do?dtId=${doctor.getDtId()}"
						...
						<div class="title-env">
							<c:forEach var="pageNo" begin="1" end="${doctorType.pageCount}">
