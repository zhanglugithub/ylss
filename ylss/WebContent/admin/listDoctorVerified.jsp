	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">医生重审</h1>
					<p class="description">显示所有审核医生</p>
				</div>
			...
			<div>
				...
				<div class="panel panel-default">
					...
					<table class="table table-model-2 table-hover">
						...
						<tbody>
							<c:forEach var="doctor" items="${doctorVerifiedList}">
								<tr>
									<td>${doctor.getDoctorId()}</td>
									<td>${doctor.getUser().getUserName()}</td>
									<td>${doctor.getUser().getPhoneNo()}</td>
									<td><button onclick="window.open('getDoctorVerified.do?phoneNo=${doctor.getUser().getPhoneNo()}')">重新审核</button></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
				...
				<div class="title-env">
					<c:forEach var="pageNo" begin="1" end="${totalNo/10+1}">
						<a href="listDoctorVerified.do?pageSize=10&pageNo=${pageNo}">
							${pageNo} </a>
					</c:forEach>
				</div>
